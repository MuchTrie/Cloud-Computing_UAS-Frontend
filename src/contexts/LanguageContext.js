...
export const translations = {
  en: {
    ...
    login: 'LOGIN',
    register: 'REGISTER',
    welcomeBack: 'Welcome back, continue your journey to greatness',
    joinTheMovement: 'Join the movement, build your legacy',
    email: 'Email',
  ...
  id: {
    ...
    login: 'MASUK',
    register: 'DAFTAR',
    welcomeBack: 'Selamat datang kembali, lanjutkan perjalanan menuju kebesaran',
    joinTheMovement: 'Bergabunglah dengan gerakan ini, bangun legasi Anda',
    email: 'Email',
    ...
    createPassword: 'Buat kata sandi yang kuat',
